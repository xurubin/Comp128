...
namespace DemoSCFmwk
{
    interface Comp128
    {
        bool Comp128(byte[] Rand, byte[] Result);
    }
    class Comp128Cracker
    {
        Comp128 comp128;

        public Comp128Cracker(Comp128 c) { comp128 = c; }
        public void InitNewSession(string sessionfile)
        {

        }
        public void RestoreSession(string sessionfile)
        {
